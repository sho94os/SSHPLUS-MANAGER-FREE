...
fun_udp1 () {
    ...
    fun_bar 'fun_udpon'
    echo -e "\n  \033[1;32m BADVPN ACTIVE!\033[0m"
    sleep 3
    menu
    } || {
        clear
        echo -e "\033[1;32m INSTALLING BADVPN\033[0m\n"
	    inst_udp () {
	        cd $HOME
	   ...
	   fun_bar 'inst_udp'
	   echo -e "\n\033[1;32m STARTING BADVPN ... \033[0m\n"
       fun_udpon2 () {
           screen -dmS udpvpn /bin/badvpn-udpgw --listen-addr 127.0.0.1:7300 --max-clients 1000 --max-connections-for-client 10
           [[ $(grep -wc "udpvpn" /etc/autostart) = '0' ]] && {
		       echo -e "ps x | grep 'udpvpn' | grep -v 'grep' && echo 'ON' || screen -dmS udpvpn /bin/badvpn-udpgw --listen-addr 127.0.0.1:7300 --max-clients 1000 --max-connections-for-client 10" >> /etc/autostart
...
fun_udp2 () {
    clear
    echo -e "\n\033[1;32m STOPPING BADVPN...\033[0m\n"
    fun_stopbad () {
        sleep 1
    ...
    fun_bar 'fun_stopbad'
    echo -e "\n  \033[1;31m BADVPN STOPPED!\033[0m"
    sleep 3
    menu
}
