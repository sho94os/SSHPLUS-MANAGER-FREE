...
echo -e "\033[1;31m[\033[1;36m2\033[1;31m]\033[1;37m • \033[1;33m Remove BANNER"
echo -e "\033[1;31m[\033[1;36m3\033[1;31m]\033[1;37m • \033[1;33m Return"
echo ""
echo -ne "\033[1;32m WHAT DO YOU WANT TO DO\033[1;31m ?\033[1;37m : "; read resp
if [[ "$resp" = "1" ]]; then
echo ""
echo -ne "\033[1;32m WHICH MESSAGE YOU WANT TO DISPLAY\033[1;31m ?\033[1;37m : "; read msg1
if [[ -z "$msg1" ]]; then
...
echo -e "\033[1;31m[\033[1;36m03\033[1;31m]\033[1;33m   BIG Font"
echo -e "\033[1;31m[\033[1;36m04\033[1;31m]\033[1;33m   GIANT SOURCE"
echo ""
...
unset ban_cor
	...
	echo " " > $local
	echo -e "\n\033[1;32mEXCLUDED BANNER!\033[0m"
	service ssh restart > /dev/null 2>&1 && service dropbear restart > /dev/null 2>&1
	sleep 2
	menu
elif [[ "$resp" = "3" ]]; then
