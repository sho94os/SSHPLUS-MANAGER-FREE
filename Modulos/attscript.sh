...
echo -e "                              \033[1;31m By OSO \033[1;36m"

echo -e "   SSHPlus" | figlet

echo " "

echo -e "   \033[1;32m CHECKING AVAILABLE UPDATES\033[0m\n"
...
[[ ! -f "/tmp/att" ]] && {
	...
	echo -ne "\033[1;31m ENTER \033[1;33m to return to \033[1;32mMENU!\033[0m"; read
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MORE INFORMATION \033[1;31m(\033[1;36m TELEGRAM\033[1;31m): \033[1;37m@OSO\n"
  ...
  echo -e "  \033[1;33m MORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@OSO\n"
  ...
  echo -ne "  \033[1;32m WANT TO UPDATE \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read res
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    echo -ne "\033[1;31mENTER \033[1;33m to return to \033[1;32mMENU!\033[0m"; read
