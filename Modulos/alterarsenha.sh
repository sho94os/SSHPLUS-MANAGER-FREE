...
echo ""
echo -e "\033[1;33m LIST OF USERS AND THEIR PASSWORDS: \033[0m"
echo""
...
echo ""
echo -ne "\033[1;32m Type or select a user \033[1;33m[\033[1;36m1\033[1;31m-\033[1;36m$num_user\033[1;33m]\033[1;37m: " ; read option
...
then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "You have entered an empty or invalid name!" ; echo "" ; tput sgr0
	exit 1
else
	if [[ `grep -c /$user: /etc/passwd` -ne 0 ]]
	then
		echo -ne "\n\033[1;32m New password for the user  \033[1;33m$user\033[1;37m: "; read password
		sizepass=$(echo ${#password})
		if [[ $sizepass -lt 4 ]]
		then
			tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Password empty or invalid! use at least 4 characters" ; echo "" ; tput sgr0
			exit 1
		else
			...
			then
				...
				tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "The password for user $user has been changed to: $password" ; echo "" ; tput sgr0
